...
//            else
//                adjustScrollBar = (maximum - extent) - value != scrollBar.getUnitIncrement() || value + extent >= maximum;
////                adjustScrollBar = value + extent >= maximum && (maximum - extent) - value != scrollBar.getUnitIncrement();
//            // maximum - extend = expected value
//            // if expected value - current value != unit increment, adjustScrollBar is still true;
//        }
    ...
    public void setAdjustScrollBar(boolean adjustScrollBar) {
        this.adjustScrollBar = adjustScrollBar;
    }

    public boolean isAdjustScrollBar() {
        return this.adjustScrollBar;
    }
}
